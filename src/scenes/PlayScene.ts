...
class PlayScene extends GameScene {
    ...
    createEnvironment() {
        ...
        this.clouds = this.clouds.addMultiple([
            ...
            this.add.image(this.gameWidth / 1.3, 100, "clouds")
        ]);
    ...
    spawnObstacle() {
        ...
        if (obstacleNum > PRELOAD_CONFIG.cactusesCount) {
            ...
            obstacle = this.obstacles.create(this.gameWidth + distance, this.gameHeight - enemyHeight, `enemy-bird`).setBodySize(20, 92)
            obstacle.play("enemy-bird-fly", true);
        } else {
            obstacle = this.obstacles.create(this.gameWidth + distance, this.gameHeight, `obstacle-${obstacleNum}`).setBodySize(44, 92)
        }
